...
Section "Main files" SEC01
  ...
  File "mm3dread\documents\copyright.txt"
...
Section "Translate HU" SEC02
  ...
  File "mm3dread\languages\hu\mm3dread.mo"
  File "mm3dread\languages\hu\mm3dread.po"
  SetOutPath "$INSTDIR\languages"
  File "mm3dread\languages\mm3dread.pot"
SectionEnd

Section -AdditionalIcons
  SetOutPath $INSTDIR
  CreateDirectory "$SMPROGRAMS\MM3DRead"
  CreateShortCut "$SMPROGRAMS\MM3DRead\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd

Section -Post
  WriteUninstaller "$INSTDIR\uninst.exe"
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\mm3dread.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\mm3dread.exe"
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\MM3DRead\MM3DRead.lnk"

  RMDir "$SMPROGRAMS\MM3DRead"
